...
std::vector<std::string> make_random_strings(size_t howMany, size_t string_len = 32)
{
...
int main()
{
    ...
    printf("ARM64 build,  in MACOS on Apple "
           "Silicon:   Arena 1.8-2.2x +\n");

    printf("x86_64 build, in MACOS on Apple "
